...
async def assess_device(db: AsyncSession, device_id: int, stat_date_ts: int, user_timezone: str | None = None) -> None:
    ...
    upsert_sql = text(f"""
        ...
        ON DUPLICATE KEY UPDATE
            ...
            scratch_duration     = VALUES(scratch_duration),
            scratch_avg_dur      = VALUES(scratch_avg_dur),
            scratch_max_dur      = VALUES(scratch_max_dur),
            night_scratch_count  = VALUES(night_scratch_count),
            temp_effect          = VALUES(temp_effect),
            ...
            worn_loose_minutes   = VALUES(worn_loose_minutes),
            wpeb_score           = VALUES(wpeb_score),
            s1_score             = VALUES(s1_score),
            s2_score             = VALUES(s2_score),
            s3_score             = VALUES(s3_score),
            s4_score             = VALUES(s4_score),
            s6_score             = VALUES(s6_score),
